![qbx_garages]<img width="1442" height="882" alt="FiveM_b3258_GTAProcess_beAzZ3YfhF" src="https://github.com/user-attachments/assets/3b825446-c244-4bdc-bb5b-cc2c7f4fea0f" />
...
## Girly Pink Tablet UI

This edition replaces the default ox_lib garage and depot context menus with a custom pink tablet interface.

Branding can be changed in `config/client.lua`:

```lua
tablet = {
    brand = 'Pink Parking',
    tagline = 'Park pretty. Drive happy ♡',
},
```

The existing Qbox garage, parking, vehicle ownership, depot fee, and spawn callbacks are preserved.
